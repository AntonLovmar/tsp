...
public interface Path {
	 ...
	 *            The new vertex
	 */
	public void replaceVertex(int index, Vertex newVertex) throws IllegalArgumentException;
	...
	/**
	 * Returns the path as a string. The path string should be a sequence of
	 * vertex id's.
	 * 
