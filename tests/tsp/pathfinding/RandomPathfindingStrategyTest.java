...
public class RandomPathfindingStrategyTest {
	...
	public void testSpanAllVertices() {
		...
		Mockito.when(graph.getVertices()).thenReturn(Arrays.asList(vertex0, vertex1, vertex2, vertex3));

		PathfindingStrategy strategy = new RandomPathfindingStrategy();
